...
class ProductRepository:
    ...
    async def create(self, label: str, description: str, price: str, path_to_image: str, worker_count: int = 1, time_to_resolve: datetime.timedelta = datetime.timedelta(days=1)) -> Optional[Product]:
