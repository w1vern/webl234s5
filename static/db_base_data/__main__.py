...
async def main():
	async with session_manager.session() as session:
		...
		for product in catalog:
			await pr.create(label=product['label'], description=product['description'], price=product['price'], sale=product['sale'], path_to_image=product['picture'], worker_count=product['worker_count'], time_to_resolve=product['time_to_resolve'])
